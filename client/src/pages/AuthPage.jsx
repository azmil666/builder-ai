...
const handleSubmit = async(e) => {
  ...
  return (
    <div className="min-h-screen bg-white flex text-zinc-900">
        {/* Left Panel - Branding */}
        <LoginLeft />
...
/>
  ...
  required
  className="w-full pl-2 py-2 border-b border-zinc-200 focus:outline-none focus:border-zinc-950 text-sm text-zinc-900 bg-transparent placeholder-zinc-300 tpr-8"
  placeholder="••••••••"
/>
<button
  type="button"
